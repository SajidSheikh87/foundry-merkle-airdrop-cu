...
This Project is created by following the **Airdrop and Signatures** section of the [Cyfrin Updraft Advanced Foundry Course](https://updraft.cyfrin.io/). 
...
```bash
git clone https://github.com/SajidSheikh87/merkle-airdrop
cd merkle-airdrop
